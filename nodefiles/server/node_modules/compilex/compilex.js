...
exports.init = function(options){
	...
	fs.exists( path.join('./Cfiles/'+options.sid) , function(exists){		
		    if(!exists)
		    {

		        mkdirp.sync('./Cfiles/'+options.sid,function(err)
		        {
		        	if(err)
		        	{
		        		if(exports.stats)
		        			{
		        				console.log('INFO: '.cyan + './Cfiles'+options.sid+'directory cannot be created for storing temporary files.'.cyan )
		        			}
		        	}
		        	else
		        	{
		        		if(exports.stats)
		        		{
		        			console.log('INFO:'.cyan+'./Cfiles'+options.sid+'directory created'.cyan);
		        		}
		        	}
		        })		    	
...
exports.justCompileCPP=function(envData,code,fn){
	...
	cppModule.justCompileCPP(envData,code,fn);
